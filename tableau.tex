...
UprightFont = *-Light ,
BoldFont = *-SemiBold ]
\usepackage[paperwidth=700mm,paperheight=1000mm,top=30mm,bottom=10mm,outer=10mm,inner=10mm]{geometry}
\usepackage{graphicx}
\usepackage{calc}
...
\begin{figure}[h!]
\centering
\large\def\svgscale{1}\input{img/tableau-no-first_8_edit.pdf_tex}
\end{figure}
\vspace{20mm}
\end{document}